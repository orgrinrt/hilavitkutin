...
**Status:** commissioned self-contained consolidation of the design of record; reading aid, not the tiebreak (A2-1, `202607193200`)
...
It consolidates, for reading convenience, the scattered set of prior
documents: the founding consolidation spec, the chain of design-round
amendments, and the reconciliation addendum A1. Per addendum A2
(`202607193200`, ruling A2-1), this document is a commissioned reading aid
with no independent design authority: it was commissioned by A1 to spare the
reader cross-reading the chain, not to override it. Where this document and
the consolidation spec or a registered amendment disagree, the disagreement
is a transcription defect in this document, to be fixed here. It does not
narrate the history of how the design was reached; it restates the design.
