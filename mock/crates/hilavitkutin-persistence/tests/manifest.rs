...
fn table_meta_default_is_empty() {
    ...
    assert_eq!(t.name_hash, ContentHash::new(0));
...
fn column_meta_default_is_empty() {
    ...
    assert_eq!(c.name_hash, ContentHash::new(0));
...
fn manifest_holds_populated_tables() {
    ...
    assert_eq!(m.tables[0].name_hash, ContentHash::new(0x0AAA_BBBB));
