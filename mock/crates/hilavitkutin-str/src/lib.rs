...
pub use crate::interner::{ArenaInterner, StrDomain, StringInterner}; // lint:allow(no-alloc) reason: `StringInterner` is the no-alloc interner wrapper, not std `String`; tracked: #72
